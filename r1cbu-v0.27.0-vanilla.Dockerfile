...
FROM x6100:R1CBU-v0.27.0.sdcard
COPY r1cbu-v0.27.0-vanilla.Dockerfile.d/ /src/r1cbu-v0.27.0-vanilla.Dockerfile.d/

#COPY R1CBU-v0.27.0.patch.tar.gz /tmp
...
RUN set -e ;\
  export \
    SRC=/src/r1cbu-v0.27.0-vanilla.Dockerfile.d/ ;\
  exec \
