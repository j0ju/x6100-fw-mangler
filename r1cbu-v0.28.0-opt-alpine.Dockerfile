...
FROM x6100:r1cbu-v0.28.0-vanilla

COPY r1cbu-v0.28.0-opt-alpine.Dockerfile.d/ /src/r1cbu-v0.28.0-opt-alpine.Dockerfile.d/
...
RUN set -e ;\
  export \
    SRC=/src/r1cbu-v0.28.0-opt-alpine.Dockerfile.d/ ;\
  exec \
