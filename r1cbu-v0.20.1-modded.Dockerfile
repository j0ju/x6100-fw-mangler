...
FROM x6100:r1cbu-v0.20.1-opt-alpine
COPY       r1cbu-v0.20.1-modded.Dockerfile.d/ /src/r1cbu-v0.20.1-modded.Dockerfile.d/
# a bit of code reuse
...
RUN set -e ;\
  export \
    SRC=/src/r1cbu-v0.20.1-modded.Dockerfile.d/ ;\
  exec \
