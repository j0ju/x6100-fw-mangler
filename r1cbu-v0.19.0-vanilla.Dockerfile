...
FROM x6100:R1CBU-v0.19.0.sdcard
COPY r1cbu-v0.19.0-vanilla.Dockerfile.d/ /src/r1cbu-v0.19.0-vanilla.Dockerfile.d/
...
RUN set -e ;\
  export \
    SRC=/src/r1cbu-v0.19.0-vanilla.Dockerfile.d/ ;\
  exec \
